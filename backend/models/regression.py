...
Wraps sklearn LinearRegression with a consistent interface
for the prediction service. The model is deterministic —
LLMs never touch these predictions.
"""
...
class LinearRegressionModel:
    """Thin wrapper around sklearn LinearRegression."""
    ...
    def get_feature_importance(self) -> dict[str, float]:
        """Return signed coefficients as feature-importance proxy."""
        if not self._is_trained:
            return {}
        return {
